  ...
  render() {
    return (
      <div className="stop-watch-section">
          <button className="task-details-stopwatch">
          {this.state.running === false && (
          <button className="task-details-button-one" onClick={this.start}><Play/></button>
        )}
        {this.state.running === true && (
          <button className="task-details-button-one" onClick={this.stop}><Pause/></button>
        )}
        <StopwatchDisplay
          ref="display"
          {...this.state}
