...
export const centerTextPlugin = {
  ...
  beforeDraw: function(chart) {
    ...
    ctx.font = "36px HelveticaNeue-Light";
    ...
    ctx.font = "14px HelveticaNeue-Light";
    ctx.textBaseline = "middle";
...
export class SmallLineChart extends React.Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <div>
          <p className="lead color-theme-1 value box_4_percent">
            {this.state.currentValue}
          </p>
          <p className="mb-0 label text-small box_4_text">{this.state.currentLabel}</p>
        </div>
        <div className="chart">
          <ChartComponent
            ref={ref => (this.chart_instance = ref && ref.chart_instance)}
