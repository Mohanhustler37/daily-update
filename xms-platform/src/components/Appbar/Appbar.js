...
import AppbarAddIcon from "../../assets/icons/01-10-2019/Icon feather-plus-circle.svg";
            ...
            <div className="ticketing-appBar">
                ...
                <div className="header-icon">
                    <div className="dropdown-button">
                        <button type="button" className="btn dropdown-toggle" data-toggle="dropdown"><span>XCELPROS</span></button>
